...
{
    public class WorkPermitEdmontonPage : AbstractPage<WorkPermitEdmontonDTO, IWorkPermitEdmontonDetails>,
        IWorkPermitEdmontonPage
    {
        private readonly PageKey pageKey;

        public WorkPermitEdmontonPage(OltGridAppearance appearance, PageKey pageKey)
            : base(
