...
{
    public class PermitRequestFortHillsWorkOrderSourceDao : AbstractManagedDao, IPermitRequestFortHillsWorkOrderSourceDao
    {
        private const string INSERT_STORED_PROC = "InsertPermitRequestFortHillsWorkOrderSource";
        private const string DELETE_STORED_PROC = "DeletePermitRequestFortHillsWorkOrderSourceByPermitRequestId";
        private const string QUERY_BY_PERMIT_REQUEST_ID_STORED_PROC = "QueryPermitRequestFortHillsWorkOrderSourceByPermitRequestId";

        public List<PermitRequestWorkOrderSource> QueryByPermitRequest(PermitRequestFortHills permitRequest)
        {
        ...
        public void InsertWorkOrderSourceList(SqlCommand command, PermitRequestFortHills permitRequest)
        {
        ...
        private static PermitRequestWorkOrderSource PopulateInstance(SqlDataReader reader, PermitRequestFortHills permitRequest)
        {
