...
{
    [Serializable]
    public class PermitRequestEdmontonSAPImportData : PermitRequestEdmonton, ISAPImportData
    {
        public PermitRequestEdmontonSAPImportData(long batchId, DateTime batchItemCreatedAt, long? id, Date endDate,
        ...
        public static List<PermitRequestEdmontonSAPImportData> RemoveDuplicateTurnaroundImports(
            List<PermitRequestEdmontonSAPImportData> data)
        {
            var map = new Dictionary<PermitKeyData, PermitRequestEdmontonSAPImportData>();
            ...
            var result = new List<PermitRequestEdmontonSAPImportData>();
