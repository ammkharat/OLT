...
{
    public class FormGenericTemplateHistory : BaseFormHistory
    {
        public FormGenericTemplateHistory(long id, FormStatus formStatus, string functionalLocations, string plainTextContent,
