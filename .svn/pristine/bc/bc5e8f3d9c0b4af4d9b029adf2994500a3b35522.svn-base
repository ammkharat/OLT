...
{
    public partial class FormEdmontonGN24Details : AbstractDetails, IFormEdmontonDetails
    {
        ...
        public FormEdmontonGN24Details()
        {
            InitializeComponent();
        ...
        {
            ExpandedLogCommentForm expandedLogCommentForm = new ExpandedLogCommentForm(PreJobMeetingSignatures, true);
            expandedLogCommentForm.ShowDialog(this);
            expandedLogCommentForm.Dispose();
        }
        ...
        {
            set {
                documentLinksControl.DataSource = value ?? new List<DocumentLink>();
            }
        }
        ...
        public bool IsForPSVRemovalOrInstallation
        {
            set { psvDataLabel.Text = value.BooleanToYesNoString(); }
        }

        public bool IsForWorkInTheAlkylationUnit
        {
            set { alkyUnitDataLabel.Text = value.BooleanToYesNoString(); }
        }

        public FormGN24AlkylationClass AlkylationClass
        {
            set { hfAlkylationClassDataLabel.Text = value != null ? value.GetName() : string.Empty; }
        }
