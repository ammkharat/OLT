...
{
    public class PermitRequestLubesGridRenderer : AbstractPageGridRenderer
    {
        ...
        public PermitRequestLubesGridRenderer()
        {
            sourceColumn = new DataSourceImageColumn<PermitRequestLubesDTO>(new[] { DataSource.MANUAL, DataSource.SAP, DataSource.CLONE });
            ...
            statusColumn = new PermitRequestCompletionStatusImageColumn(new[] { PermitRequestCompletionStatus.Complete, PermitRequestCompletionStatus.Incomplete, PermitRequestCompletionStatus.Expired});
            ////commented and added by Dharmesh End on 24-Nov-2016 for INC0029812 (#3380)

            AddImageColumn(statusColumn);

            craftOrTradeColumnHeaderText = RendererStringResources.Trade;
        }
        ...
        protected override void LoadDefaultColumnLayout(UltraGridBand band)
        {
            ...
            band.Columns[END_DATE_COLUMN_KEY].FormatAsDate(RendererStringResources.End, column++, 100);
