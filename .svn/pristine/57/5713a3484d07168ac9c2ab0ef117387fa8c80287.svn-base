...
{
    public class ConfinedSpaceHistoryFormPresenter : EditHistoryFormPresenter
    {
        private readonly ConfinedSpace confinedSpace;

        public ConfinedSpaceHistoryFormPresenter(ConfinedSpace confinedSpace)
            : base(confinedSpace)
        {
        ...
        {
            return editHistoryService.GetEditHistoryForConfinedSpace(confinedSpace.IdValue);
        }
