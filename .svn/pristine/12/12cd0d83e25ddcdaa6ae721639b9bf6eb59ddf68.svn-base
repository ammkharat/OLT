...
{
    [Serializable]
    public class FormEdmontonDTO : DomainObject, IHasStatus<FormStatus>, IFormEdmontonDTO
    {
        private readonly List<string> functionalLocations = new List<string>();

        public FormEdmontonDTO(long id, List<string> functionalLocations, EdmontonFormType formType,
        ...
        public FormEdmontonDTO(long id, List<string> functionalLocations, EdmontonFormType formType,
            long createdByUserId, string createdByFullNameWithUserName, DateTime createdDateTime,
            long lastModifiedByUserId, DateTime validFrom, DateTime validTo, FormStatus formStatus,
            DateTime? approvedDateTime, DateTime? closedDateTime, List<string> remainingApprovals,string location)
        {
            Id = id;
            functionalLocations.ForEach(AddFunctionalLocation);
            FormType = formType;
        ...
        public string Location { get; private set; } ////RITM0465936:EN50 : OLT:: Sarnia : Priorities page changes:Aarti
