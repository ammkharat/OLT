...
{
    [TestFixture]
    public class ArchiveClosedWorkPermitJobTest
    {
        private ArchiveClosedWorkPermitJob job;
        ...
        public void SetUp()
        {
            ...
            job =
                new ArchiveClosedWorkPermitJob(
        ...
        public void ShouldExecuteDeleteInactivePendingWorkPermits()
        {
            ...
            foreach (var testSite in sites)
            {
                Expect.Once.On(mockWorkPermitService)
                    .Method("ArchiveCompletedWorkPermitsBySiteConfiguration")
                    .With(testSite);
            }
            job.Execute();
