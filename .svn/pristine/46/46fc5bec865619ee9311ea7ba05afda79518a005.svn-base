...
{
    public class SelectFormPresenter<TDto, TEdmontonForm, TDetails, TPage> : AbstractDeletableDomainPagePresenter<TDto, TEdmontonForm, TDetails, TPage> 
        ...
        where TPage : FormPage<TDto, TDetails>
    {
        ...
        public SelectFormPresenter(EdmontonFormType formType, TPage formPage, Range<DateTime> dateTimeRangeOfWorkPermit)
            : this(formType, formPage, null, false, dateTimeRangeOfWorkPermit)
        {
        }

        public SelectFormPresenter(EdmontonFormType formType, TPage formPage, Range<Date> dateRangeOfPermitRequest)
            : this(formType, formPage, null, false, dateRangeOfPermitRequest)
        {
        }

        public SelectFormPresenter(EdmontonFormType formType, TPage formPage, PostSelectFormActionDelegate postSelectFormActionDelegate, bool keepFormOpenAfterNewOrEdit, Range<DateTime> dateTimeRangeOfWorkPermit)
            : this(formType, new List<FormStatus> { FormStatus.Draft, FormStatus.Approved }, true, true, formPage, postSelectFormActionDelegate, keepFormOpenAfterNewOrEdit)
        {
            this.dateTimeRangeOfWorkPermit = dateTimeRangeOfWorkPermit;
        }

        public SelectFormPresenter(EdmontonFormType formType, TPage formPage, PostSelectFormActionDelegate postSelectFormActionDelegate, bool keepFormOpenAfterNewOrEdit, Range<Date> dateRangeOfPermitRequest)
            : this(formType, new List<FormStatus> { FormStatus.Draft, FormStatus.Approved }, true, true, formPage, postSelectFormActionDelegate, keepFormOpenAfterNewOrEdit)
        {
            this.dateRangeOfPermitRequest = dateRangeOfPermitRequest;
        }

        private SelectFormPresenter(EdmontonFormType formType, List<FormStatus> formStatuses, bool allowCreationOfNewForms, bool allowEditOfExistingForms, 
        ...
        protected override void ControlDetailButtons()
        {
            ...
            details.EditEnabled = hasSingleItemSelected && authorized.ToEditEdmontonForm(userRoleElements, selectedItems[0].Status, selectedItems[0].FormType);
        }
