...
{
    public partial class ConfigureCraftOrTradeForm : BaseForm, IConfigureCraftOrTradeView
    {
        ...
        public ConfigureCraftOrTradeForm()
        {
            InitializeComponent();           
            ...
            new ConfigureCraftOrTradePresenter(this).RegisterToViewEvents();
        }        
        ...
        {
            CraftOrTradeForm craftOrTradeForm = new CraftOrTradeForm();
            return craftOrTradeForm.ShowDialog(this);
        }

        public DialogResult EditCraftOrTrade(CraftOrTrade craftOrTrade)
        {
            CraftOrTradeForm craftOrTradeForm = new CraftOrTradeForm(craftOrTrade);
            return craftOrTradeForm.ShowDialog(this);
        }
