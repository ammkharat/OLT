...
{
    public class ReadingDefinitionPage : AbstractPage<ActionItemDefinitionDTO, IActionItemDefinitionDetails>, IActionItemDefinitionPage
    {
        public ReadingDefinitionPage()
            :base
                (
        ...
        {
            get { return PageKey.READING_DEFINITION_PAGE; }
        }
