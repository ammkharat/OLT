...
{
    [Serializable]
    public class ConfinedSpaceDTO : DomainObject, IHasStatus<ConfinedSpaceStatus>
    {
        public ConfinedSpaceDTO(long id, long confinedSpaceNumber, string functionalLocationName, DateTime startDateTime,
        ...
        public ConfinedSpaceDTO(ConfinedSpace confinedSpace) : this(
        ...
        [IncludeInSearch]
        public ConfinedSpaceStatus Status
        {
            get { return ConfinedSpaceStatus.Get(ConfinedSpaceStatusId); }
        }
    }
}