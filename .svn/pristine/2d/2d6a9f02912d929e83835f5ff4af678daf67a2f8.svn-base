...
{
    public class SelectFormGN75BFormPresenter : SelectFormPresenter<FormEdmontonGN75BDTO, FormGN75B, FormEdmontonGN75BDetails, FormPage<FormEdmontonGN75BDTO, FormEdmontonGN75BDetails>>
    {
        public SelectFormGN75BFormPresenter(FormPage<FormEdmontonGN75BDTO, FormEdmontonGN75BDetails> formPage) : base(EdmontonFormType.GN75B, formPage, default(Range<Date>))
        {
        }
