IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'QueryFormLubesCsdDTOsByFunctionalLocationsAndOtherThings')
    BEGIN
        DROP PROCEDURE [dbo].QueryFormLubesCsdDTOsByFunctionalLocationsAndOtherThings
    END
GO

CREATE Procedure [dbo].QueryFormLubesCsdDTOsByFunctionalLocationsAndOtherThings
    (
...
GRANT EXEC on QueryFormLubesCsdDTOsByFunctionalLocationsAndOtherThings TO PUBLIC
GO