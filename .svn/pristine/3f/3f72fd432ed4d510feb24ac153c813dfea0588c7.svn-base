IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'QueryWorkPermitEdmontonDTOByFormGN24Id')
    BEGIN
        DROP PROCEDURE [dbo].QueryWorkPermitEdmontonDTOByFormGN24Id
    END
GO

CREATE Procedure [dbo].QueryWorkPermitEdmontonDTOByFormGN24Id
    (
		@FormGN24Id bigint
    )
AS
