...
{
    public class CSDPipelineActiveFormContex :
        AbstractEdmontonFormContext<FormEdmontonOP14DTO, FormOP14, FormPipelineOP14Details>
    {
        ...
        public CSDPipelineActiveFormContex(IFormEdmontonService formService, AbstractMultiGridPage page)
        ...
        public override void SetDetailData(FormPipelineOP14Details details, FormOP14 form)
        {
            ...
            details.MarkAsReadVisible = (userContext.SiteConfiguration.EnableCSDMarkAsRead &&
