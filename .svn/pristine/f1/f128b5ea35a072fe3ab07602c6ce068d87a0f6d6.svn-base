...
{
    public class OP14TimerManager
    {
        private static readonly ILog logger = LogManager.GetLogger(typeof(OP14TimerManager));
        ...
        public void RegisterTimer(FormEdmontonOP14DTO op14Dto, TimeSpan dueTime, TimerCallback callback)
        {
        ...
        public void Unregister(FormEdmontonOP14DTO op14Dto)
        {
            try
            {
                locker.AcquireWriterLock(Timeout.Infinite);
