...
// Added By Vibhor : DMND0010816 -MUDS - Implement OLT Work permit
       ...
       private void permitAttributesControl_Enter(object sender, EventArgs e)
        {
           if (Convert.ToString(permitAttributesControl.SelectedAttributes) == "Perçage ou piquage à vif")
           {
       ...
       public bool Procédure_Attribute_CheckBox
       {
           get { return Procédure_checkBox.Checked; }
           set { Procédure_checkBox.Checked = value; }
       }
