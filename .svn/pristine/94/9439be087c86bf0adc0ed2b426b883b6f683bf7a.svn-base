...
--//Insert Data
IF not EXISTS (
select * from FormGenericTemplateEmailApprover where   Name like 'Supervisor' and FormTypeID = 3 and SiteID = 1 and PlantID = 0 and IsDeleted=0
)
Begin
INSERT [dbo].FormGenericTemplateEmailApprover ([FormTypeID], [Name], [SiteID], [PlantID],[IsDeleted]) VALUES (3,'Supervisor',1,0,0)
End
