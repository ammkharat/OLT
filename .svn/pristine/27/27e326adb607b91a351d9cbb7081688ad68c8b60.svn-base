...
{
    [Serializable]
    public class MontrealCsdDTO : FormEdmontonDTO
    {
        public MontrealCsdDTO(long id, List<string> functionalLocations, string criticalSystemDefeated,
        ...
        private static List<string> GetApprovers(MontrealCsd montrealCsd)
        {
