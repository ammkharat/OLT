...
namespace Com.Suncor.Olt.Remote.DataAccess.Domain
{
    [TestFixture]
    [Category("Database")]
    public class FormGN7HistoryDaoTest : AbstractDaoTest
    {
        private IFormGN7HistoryDao dao;
        private IFormGN7Dao formDao;
        ...
        public void ShouldInsert()
        {
            ...
            var form = FormGN7Fixture.CreateForInsert(new List<FunctionalLocation> {floc2, floc1},
                validFromDateTime,
                validToDateTime,
                FormStatus.Draft);
        ...
        {
            dao = DaoRegistry.GetDao<IFormGN7HistoryDao>();
            formDao = DaoRegistry.GetDao<IFormGN7Dao>();
        }
