...
{
    public class WorkPermitMontrealNettoyageReportAdapter : IReportAdapter
    {
        private readonly WorkPermitMontreal permit;
        private readonly WorkPermitMontrealTemplate template;

        public WorkPermitMontrealNettoyageReportAdapter(WorkPermitMontreal permit)
        {
            this.permit = permit;
        ...
        {
            get { return WorkPermitMontrealReportAdapter.TruncatedFunctionalLocations(permit.FunctionalLocations); }
        }
