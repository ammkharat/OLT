...
{
    public class EditWorkPermitFortHillsHistoryFormPresenter : EditHistoryFormPresenter
    {
        private readonly WorkPermitFortHills workPermit;

        public EditWorkPermitFortHillsHistoryFormPresenter(WorkPermitFortHills workPermit)
            : base(workPermit)
        {
