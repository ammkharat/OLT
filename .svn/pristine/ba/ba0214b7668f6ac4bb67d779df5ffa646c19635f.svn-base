...
{
    public class PriorityPageExcursionEventDetailsPresenter : MultiGridEdmontonFormPagePresenter
    {
        private readonly IGridAndDetailsView view;

        public PriorityPageExcursionEventDetailsPresenter(GridAndDetailsForm gridAndDetailsForm, MultiGridFormPage page,
            List<IMultiGridContext> contexts)
            : base(page, contexts)
        {
        ...
        public void Run(IWin32Window parent)
        {
            ...
            var details = (FormLubesCsdDetails) page.CurrentGridContext.Details;
