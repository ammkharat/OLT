IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'QueryFlexiShiftHandoverQuestionnaireDTOsByParentFlocListAndMarkedAsRead')
    BEGIN
        DROP PROCEDURE [dbo].QueryFlexiShiftHandoverQuestionnaireDTOsByParentFlocListAndMarkedAsRead
    END
GO

CREATE Procedure [dbo].QueryFlexiShiftHandoverQuestionnaireDTOsByParentFlocListAndMarkedAsRead          
    (          
...
GRANT EXEC ON QueryFlexiShiftHandoverQuestionnaireDTOsByParentFlocListAndMarkedAsRead TO PUBLIC
GO