...
{
    public class DocumentSuggestionNodeData : NodeData<DocumentSuggestionDTO>
    {
        private static readonly Dictionary<FormStatus, IImageMapItem<FormStatus>> imageMapItems = CreateDictionary(DocumentSuggestionFormStatusImageColumn.GetImageMapItems());

        private DocumentSuggestionDTO dto;

        public DocumentSuggestionNodeData(DocumentSuggestionDTO dto)
            : base(dto)
        {
            this.dto = dto;
        }

        public DocumentSuggestionDTO Dto
        {
            get { return dto; }
        }
        ...
        public override string StartEndText
        {
            get
            {
                return dto.DocumentOwner.IsNullOrEmptyOrWhitespace() ? "Unknown" : dto.DocumentOwner;
            }
        }
        ...
        {
            return string.Format("# {0} - ({1}) {2}", dto.FormNumber, dto.DocumentNumber, dto.DocumentTitle);
        }
        ...
        {
            DocumentSuggestionNodeData other = nodeData as DocumentSuggestionNodeData;
