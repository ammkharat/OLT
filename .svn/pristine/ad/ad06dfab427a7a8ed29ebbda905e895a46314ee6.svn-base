...
{
    class PermitRequestFortHillsGridRenderer : AbstractPageGridRenderer
    {
        ...
        public PermitRequestFortHillsGridRenderer()
        {
            sourceColumn = new DataSourceImageColumn<PermitRequestFortHillsDTO>(new[] { DataSource.MANUAL, DataSource.SAP, DataSource.CLONE });
            ...
            priorityColumn = new PriorityImageColumn<PermitRequestFortHillsDTO>(new List<Priority>(WorkPermitFortHills.Priorities));
