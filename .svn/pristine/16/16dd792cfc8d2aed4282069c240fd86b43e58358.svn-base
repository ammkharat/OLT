...
--ALTER TABLE [dbo].[WorkPermitFortHillsDetails]  WITH CHECK ADD  CONSTRAINT [FK_WorkPermitFortHillsDetails_Id] FOREIGN KEY([WorkPermitFortHillsId])
--REFERENCES [dbo].[WorkPermitFortHills] ([Id])
--GO

--ALTER TABLE [dbo].[WorkPermitFortHillsDetails] CHECK CONSTRAINT [FK_WorkPermitFortHillsDetails_Id]
--GO
END
