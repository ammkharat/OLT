...
{
    [Serializable]
    public class WorkPermitMudsDTO : DomainObject, IHasStatus<PermitRequestBasedWorkPermitStatus>, IHasDataSource
    {
        ...
        private readonly string mudsAnswerTextBox;
        ...
        public WorkPermitMudsDTO(WorkPermitMuds domainObject)
        {
            ...
            mudsAnswerTextBox = domainObject.MudsAnswerTextBox; // Added By Vibhor - RITM0632893 : Add a section with a question that could trigger a flag in the dashboard when an operator answer yes.

        }

        public WorkPermitMudsDTO(
            long id,
            ...
            )
        {
            ...
            this.mudsAnswerTextBox = mudsAnswerTextBox;
        }

//Added By Vibhor : DMND0010779 : OLT - Templateeasy clone
        public WorkPermitMudsDTO(long id, long? permitNumber, string templateName, string categories, string wp_TypeName, string desc, List<string> functionalLocationNames)
        {
            this.id = id;
            this.permitNumber = permitNumber;
...
// Added By Vibhor - RITM0632893 : Add a section with a question that could trigger a flag in the dashboard when an operator answer yes.
        ...
        public bool IsQuestionAnswered
        {
            get
            {
                if ((MudsAnswerTextBox != String.Empty && MudsAnswerTextBox != null))
                {
                    return true;
                }
                else
