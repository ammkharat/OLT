...
{
    public partial class WorkPermitAssignmentConfigurationForm : BaseForm, IWorkPermitAssignmentConfigurationFormView
    {
        ...
        public WorkPermitAssignmentConfigurationForm()
        {
            InitializeComponent();
