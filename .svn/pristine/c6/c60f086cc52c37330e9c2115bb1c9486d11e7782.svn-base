...
--Begin
	...
	INSERT INTO [dbo].[FunctionalLocation] (SiteId, [Description], FullHierarchy, OutOfService, Deleted, [Level], PlantId, Culture, Source) VALUES (@siteid, N'General', N'TLP-General', 0, 0, 2,1365 , N'en', 2)
	INSERT INTO [dbo].[FunctionalLocation] (SiteId, [Description], FullHierarchy, OutOfService, Deleted, [Level], PlantId, Culture, Source) VALUES (@siteid, N'Sub General', N'TLP-Sub-General', 0, 0, 3, 1365, N'en', 2)
--	set @index = @index + 1
--End
