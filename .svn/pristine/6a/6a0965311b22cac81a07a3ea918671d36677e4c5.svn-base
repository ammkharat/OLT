...
{
    [TestFixture]
    public class DeleteInactivePendingWorkPermitsJobTest
    {
        private DeleteInactivePendingWorkPermitsJob job;
        ...
        public void SetUp()
        {
            ...
            job =
                new DeleteInactivePendingWorkPermitsJob(
        ...
        public void ShouldExecuteDeleteInactivePendingWorkPermits()
        {
            ...
            foreach (var testSite in sites)
            {
                Expect.Once.On(mockWorkPermitService)
                    .Method("DeleteInactivePendingWorkPermitsBySiteConfiguration")
                    .With(testSite);
            }
            job.Execute();
