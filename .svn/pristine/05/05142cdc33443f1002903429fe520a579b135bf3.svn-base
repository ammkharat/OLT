...
{
    public partial class FormEdmontonOP14Details : AbstractDetails, IFormEdmontonDetails
    {
        ...
        public FormEdmontonOP14Details()
        {
            InitializeComponent();
       ...
       public bool MarkedAsReadToggleCollaps
       {
        ...
        {
            set { isTheCSDForAPressureSafetyValveDataLabel.Text = value != null ? value.Value.BooleanToYesNoString() : string.Empty; }
        }
        ...
        //private void markAsReadButton_Click_1(object sender, EventArgs e)
        //{
        //    //FormEdmontonOP14DTO a = new FormEdmontonOP14DTO();
