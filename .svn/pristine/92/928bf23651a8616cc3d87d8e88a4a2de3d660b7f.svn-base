IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'UpdateWorkPermitForUSPipeline')
	BEGIN
		DROP PROCEDURE [dbo].UpdateWorkPermitForUSPipeline
	END
GO

create PROCEDURE [dbo].[UpdateWorkPermitForUSPipeline]
(
    @Version varchar(10),
...
GRANT EXEC ON UpdateWorkPermitForUSPipeline TO PUBLIC
