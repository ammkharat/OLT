...
{
    public class MarkedAsReadReportFormPresenter
    {
        private readonly IMarkedAsReadReportFormView view;
        private readonly IStreamingReportingService streamingReportingService;

        public MarkedAsReadReportFormPresenter(
            IMarkedAsReadReportFormView view, 
            bool includeLogsAndSummaryLogsByDefault, 
            ...
            bool includeDirectivesByDefault)
        {
            ...
            view.LogsChecked = includeLogsAndSummaryLogsByDefault;
            view.SummaryLogsChecked = includeLogsAndSummaryLogsByDefault;
        ...
        public void RunReportButton_Click(object sender, EventArgs e)
        {
            if (Validate())
            {
                ...
                Stream stream = streamingReportingService.GetMarkedAsReadReportData(
                    ...
                    view.DirectivesChecked, view.FlexiShiftHandoverChecked);//Aarti:INC0538563:"Mark As Read" issue.Both Directive and Directive logs should come in report.
        ...
        private bool Validate()
        {
            ...
            if (!view.LogsChecked &&
                !view.SummaryLogsChecked &&
                !view.DirectivesChecked && 
                !view.ShiftHandoverChecked &&
                !view.FlexiShiftHandoverChecked)
            {
