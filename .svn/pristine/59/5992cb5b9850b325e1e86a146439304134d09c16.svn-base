...
{
    public partial class FormMontrealCsdForm : BaseForm, IFormMontrealCsdView
    {
        private readonly IMultiSelectFunctionalLocationSelectionForm flocSelector;

        public FormMontrealCsdForm()
        {
            InitializeComponent();
            ...
            pressureSafetyValveNoRadioButton.CheckedChanged += HandlePressureSafetyValveNoRadioButtonOnCheckedChanged; //MS: 3664 - Ayman
