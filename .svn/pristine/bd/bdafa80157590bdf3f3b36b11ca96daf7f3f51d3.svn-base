...
{
    public class CraftOrTradeFormPresenter : AbstractFormPresenter<ICraftOrTradeView, CraftOrTrade>
    {
        private readonly ICraftOrTradeService craftOrTradeService;

        public CraftOrTradeFormPresenter(ICraftOrTradeView view)
            : this(view, null)
        {
        }

        public CraftOrTradeFormPresenter(ICraftOrTradeView view, CraftOrTrade craftOrTradeToEdit)
            : this(view, craftOrTradeToEdit, ClientServiceRegistry.Instance.GetService<ICraftOrTradeService>())
        {
        }

        public CraftOrTradeFormPresenter(
        ...
        private void UpdateViewFromEditObject()
        {
            ...
            view.ViewTitle = StringResources.CraftOrTradeFormEditTitle;
        }

        protected void UpdateViewWithDefaults()
        {
            view.ViewTitle = StringResources.CraftOrTradeFormCreateTitle;
        }
        ...
        {            
            craftOrTradeService.Insert(craftOrTrade.Item);
        }

        public override void Update(SaveUpdateDomainObjectContainer<CraftOrTrade> craftOrTrade)
        {
            craftOrTradeService.Update(craftOrTrade.Item);
        }
        ...
        public override bool ValidateViewHasError()
        {
            ...
            else 
            {
                CraftOrTrade duplicateCraftOrTrade = 
                    craftOrTradeService.QueryByWorkCentreAndNameAndSiteId(view.WorkCentre, name, userContext.SiteId);
