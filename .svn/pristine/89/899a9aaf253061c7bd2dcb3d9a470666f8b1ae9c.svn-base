...
{
    public partial class ImportPermitRequestMultiDayForm : BaseForm, IImportPermitRequestMultiDayFormView
    {
        public event EventHandler ImportButtonClicked;
        public event EventHandler CancelButtonClicked;      

        public ImportPermitRequestMultiDayForm()
        {
            InitializeComponent();
        ...
        public void SetErrorForTooManyDaysSelected(int maximumNumberOfDays)
        {
            errorProvider.SetError(endRangeDatePicker, String.Format(StringResources.MaximumXDaysAllowed, maximumNumberOfDays));
        }

        public void SetErrorForEndDateBeforeStartDate()
        {
            errorProvider.SetError(endRangeDatePicker, StringResources.FromDateBeforeToDate);            
        }
    }
}