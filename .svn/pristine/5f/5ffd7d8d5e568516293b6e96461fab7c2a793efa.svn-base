...
IF not EXISTS (
select * from GasTestElementInfo where  Name like 'Other (2)' and SiteId = 1 AND		Deleted = 0
)
Begin
Insert Into [GasTestElementInfo] ( [Name],[Standard],[SiteId],[DisplayOrder],[ColdMaxValue],[ColdMinValue],[HotMaxValue],[HotMinValue],[CSEMaxValue],[CSEMinValue],[InertCSEMaxValue],
[InertCSEMinValue],[OtherLimits],[GasLimitUnitId],[RangedLimit],[DecimalPlaceCount]) VALUES  (    'Other (2)',    1,    1,    11,    NULL,    NULL,    NULL,    NULL,    NULL,    NULL,    NULL,    NULL,    NULL,    NULL,    1,    1)
