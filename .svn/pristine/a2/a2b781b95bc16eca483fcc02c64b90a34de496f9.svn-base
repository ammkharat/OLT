...
{
    public class WorkPermitFortHillsDTODao : AbstractManagedDao, IWorkPermitFortHillsDTODao
    {
        private const string QUERY_BY_DATE_RANGE_AND_FLOC_IDS_STORED_PROCEDURE = "QueryWorkPermitFortHillsDTOByDateRangeAndFlocIds";
        ...
        public List<WorkPermitFortHillsDTO> QueryByDateRangeAndFlocsAndPriorityIds(Range<Date> dateRange, IFlocSet flocSet, List<long> priorityIds, bool excludeTheGivenPriorityIds)
        {
            ...
            return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_DATE_RANGE_AND_FLOC_IDS_STORED_PROCEDURE);            
        }

        public List<WorkPermitFortHillsDTO> QueryByDateRangeAndFlocs(Range<Date> dateRange, IFlocSet flocSet)
        {
            return QueryByDateRangeAndFlocsAndPriorityIds(dateRange, flocSet, null, false);
        }

        //public List<WorkPermitFortHillsDTO> QueryByFormGN59Id(long formGN59Id)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN59Id", formGN59Id);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN59_ID);
        //}

        //public List<WorkPermitFortHillsDTO> QueryByFormGN7Id(long formGN7Id)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN7Id", formGN7Id);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN7_ID);
        //}

        //public List<WorkPermitFortHillsDTO> QueryByFormGN24Id(long formGN24Id)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN24Id", formGN24Id);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN24_ID);
        //}

        //public List<WorkPermitFortHillsDTO> QueryByFormGN6Id(long formGN6Id)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN6Id", formGN6Id);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN6_ID);
        //}

        //public List<WorkPermitFortHillsDTO> QueryByFormGN75AId(long formGN75AId)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN75AId", formGN75AId);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN75A_ID);        
        //}

        //public List<WorkPermitFortHillsDTO> QueryByFormGN1Id(long formGN1Id)
        //{
        //    SqlCommand command = ManagedCommand;
        //    command.AddParameter("@FormGN1Id", formGN1Id);
        //    return command.QueryForListResult<WorkPermitFortHillsDTO>(PopulateInstance, QUERY_BY_FORM_GN1_ID);        
        //}

        private static WorkPermitFortHillsDTO PopulateInstance(SqlDataReader reader)
        {
            ...
            DateTime? revalidationDatetime = reader.Get<DateTime?>("RevalidationDatetime");
            DateTime? extensionDateTime = reader.Get<DateTime?>("ExtensionDateTime");
            ...
            WorkPermitFortHillsDTO dto = new WorkPermitFortHillsDTO(id, dataSourceId, workPermitStatusId, workPermitTypeId, requestedStartDateTime,
                                                                  ...
                                                                  company, permitAcceptor, priority,revalidationDatetime,extensionDateTime);
