...
{
    public class ConfinedSpaceMudsGridRenderer : AbstractPageGridRenderer
    {
        ...
        protected readonly ConfinedSpaceMudsStatusImageColumn statusImageColumn;

        public ConfinedSpaceMudsGridRenderer()
            : base(FUNCTIONAL_LOCATION_NAME_COLUMN_KEY)
        {
            statusImageColumn = new ConfinedSpaceMudsStatusImageColumn();
