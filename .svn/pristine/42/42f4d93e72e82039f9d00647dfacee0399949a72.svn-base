...
namespace Com.Suncor.Olt.Remote.DataAccess.Domain
{
    [TestFixture]
    [Category("Database")]
    public class FormLubesCsdHistoryDaoTest : AbstractDaoTest
    {
        private IFormLubesCsdHistoryDao dao;
        ...
        public void ShouldInsert()
        {
            ...
            var form = FormLubesCsdFixture.CreateForInsert(floc1,
...

            {
                ...
                Assert.AreEqual("ED1-A001-U007", requeried.FunctionalLocation);
        ...
        {
            dao = DaoRegistry.GetDao<IFormLubesCsdHistoryDao>();
