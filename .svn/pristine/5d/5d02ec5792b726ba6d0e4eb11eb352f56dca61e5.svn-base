...
{
    public class EditWorkPermitMontrealGroupPresenter : BaseWorkPermitMontrealGroupPresenter
    {
        private readonly WorkPermitMontrealGroup editObject;
                       
        public EditWorkPermitMontrealGroupPresenter(IAddEditWorkPermitMontrealGroupView view, WorkPermitMontrealGroup group, List<WorkPermitMontrealGroup> allGroupsInUI) : base(view, allGroupsInUI)
        {            
            editObject = group;            
