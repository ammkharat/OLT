...
WHERE object_id = OBJECT_ID(N'[dbo].[FormMudsTemporaryInstallation]') AND type in (N'U'))
...
IF  NOT EXISTS (SELECT * FROM sys.objects 
WHERE object_id = OBJECT_ID(N'[dbo].[FormMudsTemporaryInstallationApproval]') AND type in (N'U'))
...
IF  NOT EXISTS (SELECT * FROM sys.objects 
WHERE object_id = OBJECT_ID(N'[dbo].[FormMudsTemporaryInstallationFunctionalLocation]') AND type in (N'U'))
...
IF  NOT EXISTS (SELECT * FROM sys.objects 
WHERE object_id = OBJECT_ID(N'[dbo].[FormMudsTemporaryInstallationHistory]') AND type in (N'U'))
