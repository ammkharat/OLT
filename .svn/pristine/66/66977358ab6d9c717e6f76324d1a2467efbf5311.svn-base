IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'QueryFormDTOsThatAreLubesCsdApprovedDraftExpiredByFunctionalLocations')
    BEGIN
        DROP PROCEDURE [dbo].QueryFormDTOsThatAreLubesCsdApprovedDraftExpiredByFunctionalLocations
    END
GO

CREATE Procedure [dbo].QueryFormDTOsThatAreLubesCsdApprovedDraftExpiredByFunctionalLocations
    (
...
GRANT EXEC on QueryFormDTOsThatAreLubesCsdApprovedDraftExpiredByFunctionalLocations TO PUBLIC
GO