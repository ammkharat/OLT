...
{
    public class PriorityPagePipelineFormOP14DetailsPresenter : MultiGridEdmontonFormPagePresenter
    {
        private readonly IGridAndDetailsView view;

        public PriorityPagePipelineFormOP14DetailsPresenter(GridAndDetailsForm gridAndDetailsForm, MultiGridFormPage page, List<IMultiGridContext> contexts)
            : base(page, contexts)
        {
        ...
        public void Run(IWin32Window parent)
        {
            ...
            FormPipelineOP14Details details = (FormPipelineOP14Details)page.CurrentGridContext.Details;
