...
{
    public class PriorityPageMontrealCsdFormContext : MontrealCsdFormContext
    {
        private readonly MontrealCsd form;
        private readonly GridAndDetailsForm gridAndDetailsForm;

        public PriorityPageMontrealCsdFormContext(GridAndDetailsForm gridAndDetailsForm, MontrealCsd form,
        ...
        protected override IList<MontrealCsdDTO> GetData(DtoFilters filters)
        {
            return new List<MontrealCsdDTO> {(MontrealCsdDTO) form.CreateDTO()};
        }
