...
namespace Com.Suncor.Olt.Client.Presenters.Validation
{
    ...
    public class ConfinedSpaceGasTestResultValidationTest
    {
        [Test][Ignore]
            ...
            var gasTestElement = new GasTestElement
                                     {
                                         ...
                                         ConfinedSpaceTestResult = 110, // out of range from 50-75 value that is standard.
                                         ElementInfo = gasTestElementInfo
                                     };

            var validation = new ConfinedSpaceGasTestResultValidation(SiteFixture.Sarnia(), gasTestElement, GasTestElementInfoFixture.SarniaStandardGasTestElementInfos);
        ...
        public void ShouldPassValidationIfElementIsNotStandard()
        {
            ...
            var gasTestElement = new GasTestElement
                                     {
                                         ConfinedSpaceTestRequired = true,
                                         ConfinedSpaceTestResult = 110, // out of range from 50-75 value, but this is non-standard so it does not matter.
                                         ElementInfo = gasTestElementInfo
                                     };
