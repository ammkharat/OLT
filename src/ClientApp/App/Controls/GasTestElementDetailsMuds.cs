...
namespace Com.Suncor.Olt.Client.Controls
{
    public partial class GasTestElementDetailsMuds : UserControl
    {
        ...
        internal GasTestElementDetailsMuds()
        {
            ...
            ThirdResultCheckBox.CheckedChanged += ThirdCheckBox_CheckedChanged;
            FourthResultCheckBox.CheckedChanged += FourthCheckBox_CheckedChanged;

        }

        public GasTestElementDetailsMuds(GasTestElementInfo info)
            : this()
        {
            ...
            Limits = info.HotLimit.ToLimitString(info.IsRangedLimit,info.DecimalPlaceCount);// string.Empty;
        ...
        private void ThirdCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            OnThirdTestRequiredChanged(ThirdResultCheckBox.Checked);
        }

        private void FourthCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            OnFourthTestRequiredChanged(FourthResultCheckBox.Checked);
        }
        ...
        public void ClearWarningMessages()
        {
            ...
            thirdResultAlertProvider.Clear();
            fourthResultAlertProvider.Clear();
        }
        ...
        public void SetConfinedSpaceTestResultAlertMessage(string alertMessage)     
        {
            confinedSpaceResultAlertProvider.SetError(confinedSpaceTestResultNumericBox, alertMessage);
        }

        public void SetImmediateAreaResultAlertMessage(string alertMessage)    
        {
            immediateAreaResulAlertProvider.SetError(immediateAreaTestResultNumericBox, alertMessage);
        }
        public void SetthirdTestResultAlertMessage(string alertMessage)     
        {
            thirdResultAlertProvider.SetError(ThirdResultNumericTextBox, alertMessage);
        }
        public void SetFourthTestResultAlertMessage(string alertMessage)     
        {
            fourthResultAlertProvider.SetError(FourthResultNumericTextBox, alertMessage);
        }
        ...
        {
            get { return ThirdResultCheckBox.Checked; }
            set
            {
                ThirdResultCheckBox.Checked = value;
                OnThirdTestRequiredChanged(value);
            }
        }

        public bool FourthTestRequired
        {
            get { return FourthResultCheckBox.Checked; }
            set
            {
                FourthResultCheckBox.Checked = value;
                OnFourthTestRequiredChanged(value);
            }
        }
        ...
        private void OnThirdTestRequiredChanged(bool value)
        {
            isThirdActive = value;
            SetGenericControlState();

            ThirdResultNumericTextBox.Enabled = value;
            if (value == false)
            {
                ThirdTestResult = null;
            }

            RaiseThirdTestChangedEvent();
        }

        private void OnFourthTestRequiredChanged(bool value)
        {
            isFourthActive = value;
            SetGenericControlState();

            FourthResultNumericTextBox.Enabled = value;
            if (value == false)
            {
                FourthTestResult = null;
            }

            RaiseFourthTestChangedEvent();
        }
        ...
        public double? ThirdTestResult
        {
            get
            {
                if (ThirdResultNumericTextBox.Value == DBNull.Value) return null;
                return (double?)ThirdResultNumericTextBox.Value;
            }
            set
            {
                ThirdResultNumericTextBox.Value = value;
            }
        }
        ...
        public double? FourthTestResult
        {
            get
            {
                if (FourthResultNumericTextBox.Value == DBNull.Value) return null;
                return (double?)FourthResultNumericTextBox.Value;
            }
            set
            {
                FourthResultNumericTextBox.Value = value;
            }
        }
        ...
        protected void RaiseThirdTestChangedEvent()
        {
            if (ThirdTestRequiredChanged != null)
            {
                ThirdTestRequiredChanged(this, EventArgs.Empty);
            }
        }

        protected void RaiseFourthTestChangedEvent()
        {
            if (FourthTestRequiredChanged != null)
            {
                FourthTestRequiredChanged(this, EventArgs.Empty);
            }
        }
        ...
        {
            set { immediateAreaTestResultNumericBox.ReadOnly = value; requiredCheckBox.Enabled=!value;}
        }
        public bool showonlyFirstColum
        {
            set {
                confinedSpaceRequiredCheckBox.Visible = !value;
                confinedSpaceTestResultNumericBox.Visible = !value;
                ThirdResultCheckBox.Visible = !value;
                FourthResultCheckBox.Visible = !value;
                ThirdResultNumericTextBox.Visible = !value;
                FourthResultNumericTextBox.Visible = !value;
