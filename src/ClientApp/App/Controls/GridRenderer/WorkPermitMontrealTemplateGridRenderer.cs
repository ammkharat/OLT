...
{
    public class WorkPermitMontrealTemplateGridRenderer : AbstractSimpleGridRenderer
    {
        ...
        protected override void SetUpColumns(UltraGridBand band)
        {
            ...
            band.Columns[DISPLAY_NAME_FIELD].SortComparer = new PropertyRowComparer<WorkPermitMontrealTemplate, int>(template => template.TemplateNumber.Value);
        }
