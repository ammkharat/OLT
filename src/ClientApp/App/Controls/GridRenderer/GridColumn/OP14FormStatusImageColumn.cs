...
{
    public class OP14FormStatusImageColumn : StatusImageColumn<IHasStatus<FormStatus>, FormStatus>
    {
        public OP14FormStatusImageColumn()
            : base(RendererStringResources.Status, GetImageMapItems())
        {
            ...
            nameToEntityMap.Add(FormStatus.WaitingForApproval.Name, FormStatus.WaitingForApproval); // Swapnil Patki For DMND0005325 Point Number 7
        }
        ...
        public static List<IImageMapItem<FormStatus>> GetImageMapItems()
        {
            return new List<IImageMapItem<FormStatus>>
            {
                ...
                new SortableSimpleDomainObjectImageMapItem<FormStatus>(FormStatus.WaitingForApproval, ResourceUtils.WAITINGFORAPPROVAL) // Swapnil Patki For DMND0005325 Point Number 7
            };
        }
    }
}