...
{
    public class WorkPermitEdmontonGridRenderer : AbstractPageGridRenderer
    {
        ...
        public WorkPermitEdmontonGridRenderer() : base(FUNCTIONAL_LOCATION_NAME_COLUMN_KEY)
        {
            sourceColumn = new DataSourceImageColumn<WorkPermitEdmontonDTO>(new[] { DataSource.MANUAL, DataSource.PERMIT_REQUEST, 
                DataSource.MERGE, DataSource.CLONE, DataSource.TEMPLATE  }); // Added By Vibhor : RITM0625399 - OLT - Include the "templates" as a source
