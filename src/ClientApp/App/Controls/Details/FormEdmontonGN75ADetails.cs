...
{
    public partial class FormEdmontonGN75ADetails : AbstractDetails, IFormEdmontonDetails
    {
        ...
        public FormEdmontonGN75ADetails()
        {
            InitializeComponent();
            ...
            viewGN75BButton.Click += HandleViewGN75BButtonClick;
        }
        ...
        private void HandleViewGN75BButtonClick(object sender, EventArgs e)
        {
            if (ViewGN75B != null)
            {
                ViewGN75B();
        ...
        public long? AssociatedGN75BFormNumber
        {
            set
            {
                if (value != null)
                {
                    associatedGN75BDataLabel.Text = Convert.ToString(value);
                    viewGN75BButton.Enabled = true;
                }
                else
                {
                    associatedGN75BDataLabel.Text = String.Empty;
                    viewGN75BButton.Enabled = false;
                }                
            }
        }
