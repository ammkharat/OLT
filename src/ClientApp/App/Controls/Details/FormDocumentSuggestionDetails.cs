...
{
    public partial class FormDocumentSuggestionDetails : AbstractDetails, IFormEdmontonDetails
    {
        ...
        public FormDocumentSuggestionDetails()
        {
            InitializeComponent();
        ...
        {
            set { suggestedCompletionDateLabel.Text = value == null ? string.Empty : value.Value.ToLongDateAndTimeString(); }
        }

        public DateTime? ScheduledCompletionDateTime
        {
            set { scheduledCompletionDateLabel.Text = value == null ? string.Empty : value.Value.ToLongDateAndTimeString(); }
        }
