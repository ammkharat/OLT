...
{
    public partial class PermitRequestMudsDetails : AbstractDetails, IPermitRequestMudsDetails
    {
        ...
        public PermitRequestMudsDetails()
        {
            InitializeComponent();
        ...
        public void SetDetails(PermitRequestMuds request)
        {
            if (request == null)
            {
...
// Added By Vibhor : DMND0010816 -MUDS - Implement OLT Work permit
                companyDataLabel_1.Text = string.Empty;
                companyDataLabel_2.Text = string.Empty;
                supervisorDataLabel.Text = string.Empty;
                nomEnt_TextBox_1.Text = string.Empty;
                nomEnt_TextBox_2.Text = string.Empty;
                nomEnt_TextBox_3.Text = string.Empty;
            ...
            else
            {
                ...
                startDateLabelData.Text = request.StartDateTime.ToLongDateAndTimeString();
                endDateDataLabel.Text = request.EndDateTime.ToLongDateAndTimeString(); //RITM0573769-Vibhor
                ...
                requestedByDataLabel.Text = request.RequestedByGroupText;
...
// Added By Vibhor : DMND0010816 -MUDS - Implement OLT Work permit
                companyDataLabel_1.Text = request.Company_1;
                companyDataLabel_2.Text = request.Company_2;
                nomEnt_TextBox_1.Text = request.Noms_1;
                nomEnt_TextBox_2.Text = request.Noms_2;
                nomEnt_TextBox_3.Text = request.Noms_3;
