...
{
    public partial class FormLubesAlarmDisableDetails : AbstractDetails, IFormEdmontonDetails
    {
        ...
        private int? alarmGroupBoxHeight;

        public FormLubesAlarmDisableDetails()
        {
            InitializeComponent();
        ...
        public string Alarm
        {
            set { alarmTextBox.Text = value ?? string.Empty; }
        }

        public string Criticality
        {
            set { criticalityDataLabel.Text = value ?? string.Empty; }
        }

        public string SapNotification
        {
            set { sapNotificationDataLabel.Text = value ?? string.Empty; }
        }
        ...
        {
            if (alarmGroupBoxHeight == null)
            {
                alarmGroupBoxHeight = alarmGroupBox.Height;
            }

            alarmGroupBox.Height = alarmGroupBoxHeight.Value;

            AdjustTextBoxHeightToFitText(alarmTextBox, alarmGroupBox);
        }
