...
{
    public partial class WorkPermitDetailsDenver_Pre_4_10 : AbstractDetails, IWorkPermitDetails
    {
        ...
        public WorkPermitDetailsDenver_Pre_4_10()
        {
            InitializeComponent();
...
//Added By Vibhor : RITM0627539 - Denver Site upgrades
        ...
        public bool PreExcavationAuthorization
        {

            set { precheck.Checked = value; }
        }

        public bool SuspendedWorkPlatform
        {

            set { suspendcheck.Checked = value; }
        }

        public bool HotTurnoverApproval
        {

            set { hotcheck.Checked = value; }
        }

        public bool ConfinedSpaceEntryAuthorizationForm
        {

            set { confinedcheck.Checked = value; }
        }

        public bool PreExcavationAuthorizationForm
        {

            set { presecondcheck.Checked = value; }
        }

        public bool SupplementalJobSiteSignInForm
        {

            set { suplementsecondcheck.Checked = value; }
        }

        public bool SystemEntryGasTestLogFrom
        {

            set { systemsecondcheck.Checked = value; }
        }

        public bool HeatStressMonitoringForm
        {

            set { heatsecondcheck.Checked = value; }
        }

        public bool CriticalLiftApprovalForm
        {

            set { criticalsecondcheck.Checked = value; }
        }
        public bool PjsrSecondSection
        {

            set { pjsrsecondcheck.Checked = value; }
        }

        public bool DeviationRequestForm
        {

            set { deviationsecondcheck.Checked = value; }
        }

        public bool RoadClosureform
        {

            set { roadseocndcheck.Checked = value; }
        }

        public bool RadiographyApprovalForm
        {

            set { radiosecondcheck.Checked = value; }
        }

        public bool ConfinedSpaceEntryTrackingLog
        {

            set { confinedLogsecondcheck.Checked = value; }
        }

        public bool FlareLineChecklists
        {

            set { flaresecondcheck.Checked = value; }
        }

        public bool HotTurnoverApprovalForm
        {

            set { hotsecondcheck.Checked = value; }
        }

        public bool IndustrialHygieneAreaRealTimeSamplingForm
        {

            set { industrialsecondcheck.Checked = value; }
        }

        public bool CraneSuspendedWorkPlatformChecklist
        {

            set { cranesecondcheck.Checked = value; }
        }

        public bool ConfinedSpaceEntryAuthorizationFormSecondSection
        {
