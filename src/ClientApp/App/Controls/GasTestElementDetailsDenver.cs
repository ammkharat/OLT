...
{
    public partial class GasTestElementDetailsDenver : UserControl, IGasTestElementDetails
    {
        private bool isStandard;

        internal GasTestElementDetailsDenver()
        {
            InitializeComponent();
            IsStandard = false;            
        ...
        public GasTestElementDetailsDenver(GasTestElementInfo info): this()
        {
        ...
        public bool ConfinedSpaceTestRequired
        {
            ...
            set { /* There is no checkbox applicable for Denver */ }
        }
