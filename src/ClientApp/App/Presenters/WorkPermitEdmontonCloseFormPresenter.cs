...
{
    public class WorkPermitEdmontonCloseFormPresenter : BaseFormPresenter<IWorkPermitCloseWithStatusFormView>
    {
        private readonly List<WorkPermitEdmonton> permits;
        ...
        private static readonly ILog logger = LogManager.GetLogger(typeof(WorkPermitEdmontonCloseFormPresenter));

        public WorkPermitEdmontonCloseFormPresenter(List<WorkPermitEdmonton> permits)
        ...
        private void Submit(object sender, EventArgs e)
        {
            try
            {
                if (Valid())
                {
                    ...
                    ServiceEventDispatcher.CallServiceAndDispatchImmediateEventNotification(workPermitEdmontonService.UpdateAndInsertLogs, permits, permitIdToAssociatedLogMap);                            
