...
{    
    public class ImportPermitRequestFortHillsFormPresenter : BaseFormPresenter<IImportPermitRequestFortHillsFormView>
    {
        private readonly IPermitRequestFortHillsService importService;
        ...
        public ImportPermitRequestFortHillsFormPresenter(IPermitRequestFortHillsService importService) : base(new ImportPermitRequestFortHillsForm())
        {
        ...
        {                                               
            ...
            foreach (Date importDate in importDates)
            {
                ...
                List<IHasPermitKey> resultsImportedThusFar = importResults.GetPermitKeyDataFromPermitRequestsFH();
                ...
                if (result.HasError)
                    break; //need to uncomment the code
            ...
            if (!severeError)
            {
                FortHillsPermitRequestPostFinalizeResult finalizeResult = importService.FinalizeImport(args.StartDate, args.EndDate, importRequestDataList, rejections, batchId, args.User);
        ...
        {           
            ...
            {
                ImportPermitRequestFortHillsErrorFormPresenter presenter = new ImportPermitRequestFortHillsErrorFormPresenter(importResults, numberOfTurnaroundPermitRequestsProcessedInFinalizeStep);
                presenter.Run(view);
            }
            else
            {
