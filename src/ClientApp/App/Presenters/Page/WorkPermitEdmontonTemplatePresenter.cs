...
namespace Com.Suncor.Olt.Client.Presenters.Page
{
        ...
        AbstractDeletableDomainPagePresenter<WorkPermitEdmontonDTO, WorkPermitEdmonton, IWorkPermitEdmontonDetails, IWorkPermitEdmontonPage>, IWorkPermitEdmontonPrintable
    {
        ...
        protected override void ControlDetailButtons()
        {
            ...
            details.DeleteVisible = hasItemsSelected;
...
//Added By Vibhor : RITM0613645 : OLT - Template Easy clone **Delete Feature**
            ...
            List<WorkPermitEdmontonDTO> permitDtos = page.SelectedItems;
            try
            {
                workPermit.LastModifiedBy = ClientSession.GetUserContext().User;
                workPermit.LastModifiedDateTime = Clock.Now;
                if (permitDtos.Count == 1)
                {
                    ...
                    ServiceEventDispatcher.CallServiceAndDispatchImmediateEventNotification(workPermitEdmontonService.RemoveTemplate, workPermit);
                }
        ...
        private void Clone(object sender, EventArgs e)
        {
            ...
            workPermit.ClonedViaTemplateTab = true; // Added By Vibhor : RITM0625399 - OLT - Include the "templates" as a source
            ...
            if (permitDtos.Count == 1)
            {
                ...
                else
                {
                    if (workPermit.TemplateName != string.Empty)
                    {
                        ...
                        ServiceEventDispatcher.CallServiceAndDispatchImmediateEventNotification(workPermitEdmontonService.UpdateTemplate, workPermit);
                    }
                    else
                    {
                        workPermit.IsTemplate = false;
