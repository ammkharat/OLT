...
{
    public class MultiGridMontrealSulphurFormPagePresenter : AbstractMultiGridPagePresenter
    {
        private static readonly EdmontonFormType InitialDropdownSelection = EdmontonFormType.TemporaryInstallationsMuds;

        protected MultiGridMontrealSulphurFormPagePresenter(MultiGridFormPage page, List<IMultiGridContext> contexts)
            : base(page,
        ...
        public static MultiGridMontrealSulphurFormPagePresenter Create()
        {
            ...
            {
                new TemporaryInstallationsFormContext(formService, page),
            };
            ...
            return new MultiGridMontrealSulphurFormPagePresenter(page, contexts);
        }
