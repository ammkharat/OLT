...
{
    public class ConfigureSiteContractorPresenter
    {
        private readonly IConfigureSiteContractorView view;
        private readonly IContractorService contractorService;
        private bool viewCloseNeedsConfirmation;
        private readonly Site site;

        public ConfigureSiteContractorPresenter(IConfigureSiteContractorView view) : 
            this(view, ClientServiceRegistry.Instance.GetService<IContractorService>())
        {
        }
        
        public ConfigureSiteContractorPresenter(IConfigureSiteContractorView view, IContractorService contractorService)
        {
            this.view = view;
        ...
        {
            Contractor selectedContractor = view.SelectedContractor;
        ...
        public void Delete()
        {
            IList<Contractor> contractors = view.Contractors;
        ...
        {
            var newContractor = new Contractor(view.ContractorName, site);
        ...
        private void AddContractorWithDuplicateCheck(IList<Contractor> contractors, Contractor newContractor)
        {
            if (contractors.Exists(
                existingContractor => existingContractor.CompanyName.TrimAndEqual(newContractor.CompanyName)))
            {
                view.ShowWarningMessage(StringResources.DuplicateContractorMessage, StringResources.DuplicateContractorTitle);
            }
            else
            {
        ...
        private void HandleUpdate(Contractor selectedContractor)
        {
            IList<Contractor> contractors = view.Contractors;
        ...
        {
            return "Configure Work Permit Contractor: " + site.Id;
        }
