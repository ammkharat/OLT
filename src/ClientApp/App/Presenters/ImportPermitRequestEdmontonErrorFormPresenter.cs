...
{
    public class ImportPermitRequestEdmontonErrorFormPresenter : BaseFormPresenter<IImportPermitRequestErrorFormView>
    {
        private readonly List<PermitRequestImportResult> resultList;
        private readonly int additionalSuccessCount = 0;

        public ImportPermitRequestEdmontonErrorFormPresenter(List<PermitRequestImportResult> resultList, int additionalSuccessCount) : base(new ImportPermitRequestErrorForm())
        {
