...
{
    public class TargetAlertExcelFormPresenter
    {
        ...
        public TargetAlertExcelFormPresenter()
        {
        ...
        {
            view.Title = StringResources.TargetAlert_Excel_Report_Title;
        ...
        public void HandleRunReportButtonClick()
        {
            ...
            {
                Stream stream = 
                    reportingService.GetTargetAlertReportData(new RootFlocSet(new List<FunctionalLocation>(view.UserSelectedFunctionalLocations)),
