...
{
    public class GenericCsdPresenter : AbstractFormEdmontonFormPresenter<GenericCsd, IFormGenericCsdView>
    {
        //private readonly IFormEdmontonService service;
        private readonly IFormGenericCSDService service;
        ...
        public GenericCsdPresenter()
            : this(CreateDefaultForm())
        {
        }

        public GenericCsdPresenter(GenericCsd form)
            : base(new FormGenericCsdForm(), form)
        {
            SaveOriginalFormValues();

            service = ClientServiceRegistry.Instance.GetService<IFormGenericCSDService>();
        ...
        {
            EditHistoryFormPresenter presenter = new GenericCsdHistoryPresenter(editObject);
            presenter.Run(view);
        }
        ...
        private static GenericCsd CreateDefaultForm()
        {
            var now = Clock.Now;
            ...
            //TODO CSD
            var form = new GenericCsd(null, FormStatus.Draft, now, now, currentUser, now);     //ayman generic forms
        ...
        {
            return ServiceEventDispatcher.CallServiceAndDispatchImmediateEventNotification(service.InsertGenericCsd,
                editObject);
        }
        ...
        protected override void Update()
        {
            ...
            ServiceEventDispatcher.CallServiceAndDispatchImmediateEventNotification(service.UpdateGenericCsd,
                editObject);
        }
