...
{
    public class SelectConfinedSpaceMudsPresenter : ConfinedSpaceMudsPagePresenter
    {
        private readonly IGridAndDetailsView view;

        public SelectConfinedSpaceMudsPresenter() : base(OltGridAppearance.SINGLE_SELECT_WRAPPED_TEXT)
        {
        ...
        protected override void Grid_DoubleClicked(object sender, DomainEventArgs<ConfinedSpaceMudsDTO> args)
        {
            AcceptButtonClicked();
        }

        public DialogResultAndOutput<ConfinedSpaceMudsDTO> Run(IWin32Window parent)
        {
            DoInitialDataLoad();
            DialogResult dialogResult = view.ShowDialog(parent);
            ConfinedSpaceMudsDTO dto = null;
            ...
            return new DialogResultAndOutput<ConfinedSpaceMudsDTO>(dialogResult, dto);
        }
