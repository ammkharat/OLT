...
{
    public class ConfinedSpaceViewValidatorMuds
    {
        private readonly IConfinedSpaceValidationActionMuds action;
        private bool hasErrors;

        public ConfinedSpaceViewValidatorMuds(IConfinedSpaceValidationActionMuds action)
        {
            this.action = action;
        }
        ...
        public void ValidateViewAndSetErrors(IConfinedSpaceViewMuds view)
        {
            ValidateDates(view);
        ...
        private void ValidateDates(IConfinedSpaceViewMuds view)
        {
        ...
        private void ValidateHasFunctionalLocation(IConfinedSpaceViewMuds view)
        {
        ...
        private void ValidateAllCheckedCheckboxesHaveAValue(IConfinedSpaceViewMuds view)
        {
