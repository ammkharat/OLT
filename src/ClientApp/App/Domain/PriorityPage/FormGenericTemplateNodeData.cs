...
{
    public class FormGenericTemplateNodeData : NodeData<FormGenericTemplateDTO>
    {
        ...
        public FormGenericTemplateNodeData(FormGenericTemplateDTO dto)
            : base(dto)
        {
        }
        ...
        {
            FormGenericTemplateNodeData other = nodeData as FormGenericTemplateNodeData;
