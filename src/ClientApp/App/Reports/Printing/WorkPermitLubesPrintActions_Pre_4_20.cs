...
{
    public class WorkPermitLubesPrintActions_Pre_4_20 : PrintActions<WorkPermitLubes, WorkPermitLubesReport_Pre_4_20, WorkPermitLubesReportAdapter>
    {
        private readonly IWorkPermitLubesService workPermitService;
        private readonly bool printEmptyForm;

        public WorkPermitLubesPrintActions_Pre_4_20(IWorkPermitLubesService workPermitService) : this(workPermitService, false)
        {           
        }

        public WorkPermitLubesPrintActions_Pre_4_20(IWorkPermitLubesService workPermitService, bool printEmptyForm)
        {
            this.workPermitService = workPermitService;
            this.printEmptyForm = printEmptyForm;
        }

        protected override WorkPermitLubesReport_Pre_4_20 CreateSpecificReport()
        {
            return new WorkPermitLubesReport_Pre_4_20();
        }

        protected override List<WorkPermitLubesReportAdapter> CreateReportAdapter(WorkPermitLubes workPermit)
        {
            WorkPermitLubesReport_Pre_4_20 report = new WorkPermitLubesReport_Pre_4_20(); // temp for doing some calculations
        ...
        protected override void AddPageSpecificWatermarks(WorkPermitLubesReport_Pre_4_20 report, IEnumerable<WorkPermitLubesReportAdapter> adapters)
        {
            int index = 0;
        ...
        protected override ReportPrintPreference CreateReportPrintPreference(WorkPermitLubesReport_Pre_4_20 report, UserPrintPreference userPrintPreferences)
        {
