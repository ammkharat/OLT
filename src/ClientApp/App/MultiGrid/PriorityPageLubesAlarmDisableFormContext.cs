...
{
    public class PriorityPageLubesAlarmDisableFormContext : LubesAlarmDisableFormContext
    {
        private readonly LubesAlarmDisableForm form;
        private readonly GridAndDetailsForm gridAndDetailsForm;

        public PriorityPageLubesAlarmDisableFormContext(GridAndDetailsForm gridAndDetailsForm, LubesAlarmDisableForm form,
        ...
        protected override IList<LubesAlarmDisableFormDTO> GetData(DtoFilters filters)
        {
            return new List<LubesAlarmDisableFormDTO> { (LubesAlarmDisableFormDTO)form.CreateDTO() };
        }
        ...
        {
            var latestVersionOfForm = formService.QueryLubesAlarmDisableFormById(form.IdValue);
