...
{
    public class PriorityPageMudsTemporaryInstallationFormContext : TemporaryInstallationsFormContext
    {
        private readonly TemporaryInstallationsMUDS form;
        private readonly GridAndDetailsForm gridAndDetailsForm;

        public PriorityPageMudsTemporaryInstallationFormContext(GridAndDetailsForm gridAndDetailsForm, TemporaryInstallationsMUDS form,
        ...
        protected override IList<TemporaryInstallationsMudsDTO> GetData(DtoFilters filters)
        {
            return new List<TemporaryInstallationsMudsDTO> { (TemporaryInstallationsMudsDTO)form.CreateDTO() };
        }
        ...
        {
            var latestVersionOfForm = formService.QueryMudsTemporaryInstallationsById(form.IdValue);
