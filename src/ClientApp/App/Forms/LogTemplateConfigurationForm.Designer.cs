...
{
    partial class LogTemplateConfigurationForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LogTemplateConfigurationForm));
            this.addButton = new OltButton();
            this.editButton = new OltButton();
            this.closeButton = new OltButton();
            this.categoryGridPanel = new OltPanel();
            this.deleteButton = new OltButton();
            this.configurableCategoryGroupBox = new OltGroupBox();
            this.buttonPanel = new OltPanel();
