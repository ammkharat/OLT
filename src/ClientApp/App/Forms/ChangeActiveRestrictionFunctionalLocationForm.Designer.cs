...
{
    partial class ChangeActiveRestrictionFunctionalLocationForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChangeActiveFunctionalLocationForm));
            ...
            this.loadDefaultAssignmentFlocsButton = new Com.Suncor.Olt.Client.OltControls.OltButton();
            ...
            this.assignmentLabel = new Com.Suncor.Olt.Client.OltControls.OltLabel();
            ...
            // 
            // loadDefaultAssignmentFlocsButton
            // 
            resources.ApplyResources(this.loadDefaultAssignmentFlocsButton, "loadDefaultAssignmentFlocsButton");
            this.functionalLocationErrorProvider.SetError(this.loadDefaultAssignmentFlocsButton, resources.GetString("loadDefaultAssignmentFlocsButton.Error"));
            this.functionalLocationErrorProvider.SetIconAlignment(this.loadDefaultAssignmentFlocsButton, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("loadDefaultAssignmentFlocsButton.IconAlignment"))));
            this.functionalLocationErrorProvider.SetIconPadding(this.loadDefaultAssignmentFlocsButton, ((int)(resources.GetObject("loadDefaultAssignmentFlocsButton.IconPadding"))));
            this.loadDefaultAssignmentFlocsButton.Name = "loadDefaultAssignmentFlocsButton";
            this.loadDefaultAssignmentFlocsButton.UseVisualStyleBackColor = true;
            // 
            ...
            this.loadPreviousFlocsPanel.Controls.Add(this.loadDefaultAssignmentFlocsButton);
            ...
            this.functionalLocationErrorProvider.SetError(this.assignmentLabel, resources.GetString("assignmentLabel.Error"));
            this.functionalLocationErrorProvider.SetIconAlignment(this.assignmentLabel, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("assignmentLabel.IconAlignment"))));
            this.functionalLocationErrorProvider.SetIconPadding(this.assignmentLabel, ((int)(resources.GetObject("assignmentLabel.IconPadding"))));
            ...
            // assignmentGroupBox
            // 
            resources.ApplyResources(this.assignmentGroupBox, "assignmentGroupBox");
            this.assignmentGroupBox.Controls.Add(this.assignmentLabel);
            this.functionalLocationErrorProvider.SetError(this.assignmentGroupBox, resources.GetString("assignmentGroupBox.Error"));
            this.functionalLocationErrorProvider.SetIconAlignment(this.assignmentGroupBox, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("assignmentGroupBox.IconAlignment"))));
            this.functionalLocationErrorProvider.SetIconPadding(this.assignmentGroupBox, ((int)(resources.GetObject("assignmentGroupBox.IconPadding"))));
            this.assignmentGroupBox.Name = "assignmentGroupBox";
            this.assignmentGroupBox.TabStop = false;
            // 
            // ChangeActiveFunctionalLocationForm
            // 
            ...
            this.Name = "ChangeActiveFunctionalLocationForm";
        ...
        private OltButton loadDefaultAssignmentFlocsButton;
        ...
        private OltLabel assignmentLabel;
