...
{
    public partial class ConfigureSiteContractorForm : BaseForm, IConfigureSiteContractorView
    {
        ...
        private readonly DomainSummaryGrid<Contractor> contractorGrid;

        public ConfigureSiteContractorForm()
        {
            InitializeComponent();           

            contractorGrid = new DomainSummaryGrid<Contractor>(new ContractorGridRenderer(), OltGridAppearance.SINGLE_SELECT, string.Empty);
            ...
            new ConfigureSiteContractorPresenter(this).RegisterToViewEvents();
        }
        ...
        public IList<Contractor> Contractors
        {
            ...
            get { return new List<Contractor>(contractorGrid.Items); }
        ...
        private void OnContractorSelected(object sender, DomainEventArgs<Contractor> e)
        {
