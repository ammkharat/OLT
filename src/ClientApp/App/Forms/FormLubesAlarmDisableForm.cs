...
{
    public partial class FormLubesAlarmDisableForm : BaseForm, IFormLubesAlarmDisableFormView
    {
        private readonly ISingleSelectFunctionalLocationSelectionForm flocSelector;

        public FormLubesAlarmDisableForm()
        {
            InitializeComponent();
            ...
            criticalityComboBox.SelectedValueChanged += HandleCriticalityComboBoxOnSelectedValueChanged;
            alarmTextBox.TextChanged += HandleAlarmTextBoxOnTextChanged;
        ...
        public event Action CriticalityChanged;
        ...
        public List<string> CriticalityChoices
        {
            set { criticalityComboBox.DataSource = value; }
        }

        public string Criticality
        {
            get { return criticalityComboBox.Text; }
            set { criticalityComboBox.Text = value; }
        }

        public string Alarm
        {
            get { return alarmTextBox.Text; }
            set { alarmTextBox.Text = value; }
        }

        public string SapNotification
        {
            get { return sapNotificationTextBox.Text; }
            set { sapNotificationTextBox.Text = value; }
        }

        public void SetErrorForEmptyCriticality()
        {
            errorProvider.SetError(criticalityComboBox, StringResources.FieldEmptyError);
        }

        public void SetErrorForEmptyAlarm()
        {
            errorProvider.SetError(alarmTextBox, StringResources.FieldEmptyError);
        }

        public void SetErrorForValidToIsInThePast()
        {
            errorProvider.SetError(validToDatePicker, StringResources.ExpiresDateInPast);
        }
        ...
        {
            errorProvider.SetError(validToTimePicker, StringResources.ExpiresDateBeforeDisabledOnDate);
        }

        public void SetErrorForTotalDurationExceeds30Days()
        {
            errorProvider.SetError(validToDatePicker, StringResources.TotalDurationExceeds30Days);
        }
        ...
        private void HandleHistoryButtonClicked(object sender, EventArgs eventArgs)
        {
        ...
        private void HandleAlarmTextBoxOnTextChanged(object sender, EventArgs eventArgs)
        {
        ...
        private void HandleCriticalityComboBoxOnSelectedValueChanged(object sender, EventArgs eventArgs)
        {
            if (CriticalityChanged != null)
            {
                CriticalityChanged();
            }
        }
