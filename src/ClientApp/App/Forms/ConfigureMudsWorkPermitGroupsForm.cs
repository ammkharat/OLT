...
{
    public partial class ConfigureMudsWorkPermitGroupsForm : BaseForm, IConfigureMudsWorkPermitGroupsView
    {        
        private readonly DomainSummaryGrid<WorkPermitMudsGroup> grid;
        ...
        public ConfigureMudsWorkPermitGroupsForm()
        {
            InitializeComponent();

            grid = new DomainSummaryGrid<WorkPermitMudsGroup>(new WorkPermitMontrealGroupGridRenderer(), OltGridAppearance.SINGLE_SELECT, string.Empty);
        ...
        public List<WorkPermitMudsGroup> Groups
        {
            get { return new List<WorkPermitMudsGroup>(grid.Items); }
            set { grid.Items = value; }
        }

        public WorkPermitMudsGroup Selected
        {
