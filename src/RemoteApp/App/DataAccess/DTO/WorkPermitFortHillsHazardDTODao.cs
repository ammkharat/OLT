...
{
    public class WorkPermitFortHillsHazardDTODao : AbstractManagedDao, IWorkPermitFortHillsHazardDTODao
    {
        private const string QUERY_BY_FLOCS_AND_STATUSES = "QueryWorkPermitEdmontonHazardDTOByFlocIdsAndStatusIds";

        public List<WorkPermitFortHillsHazardDTO> QueryByFlocsAndStatus(IFlocSet flocSet, List<PermitRequestBasedWorkPermitStatus> statuses)
        {
            ...
            return command.QueryForListResult<WorkPermitFortHillsHazardDTO>(PopulateInstance, QUERY_BY_FLOCS_AND_STATUSES);
        }

        private static WorkPermitFortHillsHazardDTO PopulateInstance(SqlDataReader reader)
        {
            ...
            return new WorkPermitFortHillsHazardDTO(id, dataSourceId, workPermitStatusId, issuedDateTime, occupation, description, hazards, createdByFullNameWithUserName);
        }
