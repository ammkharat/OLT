...
namespace Com.Suncor.Olt.Remote.Services
{
    ...
    public class FormGenericCSDService : IFormGenericCSDService
    {
        ...
        private readonly IGenericCsdDTODao montrealCsdDTODao;
        private readonly IGenericCsdDao montrealCsdDao;
        ...
        public FormGenericCSDService(IFormGN7Dao formGN7Dao,
            ...
            IGenericCsdDao montrealCsdDao,
            IGenericCsdDTODao montrealCsdDTODao,
        ...
        public FormGenericCSDService()
            : this(DaoRegistry.GetDao<IFormGN7Dao>(),
                ...
                DaoRegistry.GetDao<IGenericCsdDao>(),
        ...
        public List<GenericCsdDTO> QueryGenericCsdDTOs(IFlocSet flocSet,
            ...
            bool includeAllDraftFormsRegardlessOfDateRange)
        {
            return montrealCsdDTODao.QueryFormGenericCsd(flocSet, dateRange, formStasuses,
   ...
   bool authorizedToViewOvertimeForms)
        {
            ...
            dtos.AddRange(
                montrealCsdDTODao.QueryFormGenericCsd(flocSet, dateRange, formStatuses, false)
                    .ConvertAll(dto => (FormEdmontonDTO)dto));
            dtos.AddRange(
            ...
            DateTime now)
        {
            ...
            dtos.AddRange(
                montrealCsdDTODao.QueryFormGenericCsdsThatAreApprovedDraftExpiredByFunctionalLocations(flocSet, now));
