...
{
    public class WorkOrderImportSettings
    {
        private static readonly ILog logger = GenericLogManager.GetLogger<WorkOrderImportSettings>();

        public virtual string URI
        {
            get { return GetString("WorkOrderImportURI", null); }
        }

        public virtual string UserName
        {
            get { return GetString("WorkOrderImportUserName", null); }
        }

        public virtual string Password
        {
            get { return GetString("WorkOrderImportPassword", null); }
        }

        public virtual TimeSpan CloseTimeout
        {
            get { return new TimeSpan(0, 0, GetInt("WorkOrderImportCloseTimeout", 1), 0); }
        }

        public virtual TimeSpan OpenTimeout
        {
            get { return new TimeSpan(0, 0, GetInt("WorkOrderImportOpenTimeout", 1), 0); }
        }
