IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'QueryWorkPermitEdmontonDTOByFormGN7Id')
    BEGIN
        DROP PROCEDURE [dbo].QueryWorkPermitEdmontonDTOByFormGN7Id
    END
GO

CREATE Procedure [dbo].QueryWorkPermitEdmontonDTOByFormGN7Id
    (
		@FormGN7Id bigint
    )
AS
...
GRANT EXEC ON QueryWorkPermitEdmontonDTOByFormGN7Id TO PUBLIC
GO