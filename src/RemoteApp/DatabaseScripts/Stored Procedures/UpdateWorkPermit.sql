...
PreExcavationAuthorization							= @PreExcavationAuthorization						,
SuspendedWorkPlatform 								= @SuspendedWorkPlatform 							,
HotTurnoverApproval 								= @HotTurnoverApproval 								,
ConfinedSpaceEntryAuthorizationForm 				= @ConfinedSpaceEntryAuthorizationForm 				,
PreExcavationAuthorizationForm 						= @PreExcavationAuthorizationForm 					,
SupplementalJobSiteSignInForm 						= @SupplementalJobSiteSignInForm 					,
SystemEntryGasTestLogFrom 							= @SystemEntryGasTestLogFrom 						,
HeatStressMonitoringForm 							= @HeatStressMonitoringForm 						,
CriticalLiftApprovalForm 							= @CriticalLiftApprovalForm 						,
PjsrSecondSection 									= @PjsrSecondSection 								,
DeviationRequestForm 								= @DeviationRequestForm 							,
RoadClosureform 									= @RoadClosureform 									,
RadiographyApprovalForm 							= @RadiographyApprovalForm 							,
ConfinedSpaceEntryTrackingLog 						= @ConfinedSpaceEntryTrackingLog 					,
FlareLineChecklists 								= @FlareLineChecklists 								,
HotTurnoverApprovalForm 							= @HotTurnoverApprovalForm 							,
IndustrialHygieneAreaRealTimeSamplingForm 			= @IndustrialHygieneAreaRealTimeSamplingForm 		,
CraneSuspendedWorkPlatformChecklist 				= @CraneSuspendedWorkPlatformChecklist 				,
ConfinedSpaceEntryAuthorizationFormSecondSection 	= @ConfinedSpaceEntryAuthorizationFormSecondSection ,
NASecondSection = @NASecondSection,
