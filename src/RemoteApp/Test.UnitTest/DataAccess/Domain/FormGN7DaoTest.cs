...
namespace Com.Suncor.Olt.Remote.DataAccess.Domain
{
    [TestFixture]
    [Category("Database")]
    public class FormGN7DaoTest : AbstractDaoTest
    {
        private IFormGN7Dao dao;
        ...
        public void PlainTextCommentsShouldSupportUnicodeCharacters()
        {
            ...
            var form = FormGN7Fixture.CreateForInsert(functionalLocations,
                Clock.Now.AddDays(-11),
                validToDateTime,
                FormStatus.Approved);
            ...
            dao.Insert(form);
            var requeriedForm = dao.QueryById(form.IdValue);
            ...
            // check update
            {
                ...
                dao.Update(form);
                requeriedForm = dao.QueryById(form.IdValue);
        ...
        public void ShouldRemove()
        {
            ...
            var dtos = dtoDao.QueryFormGN7(flocSet,
                new DateRange(new Date(validFromDateTime), new Date(validToDateTime)),
                FormStatus.All,
                false);
            ...
            var listWithoutNewForm = dtoDao.QueryFormGN7(flocSet,
                new DateRange(new Date(validFromDateTime), new Date(validToDateTime)),
                FormStatus.All,
                false);
        ...
        public void ShouldUpdateForm()
        {
            ...
            var form = FormGN7Fixture.CreateForInsert(new List<FunctionalLocation> {floc1, floc2},
                validFrom,
                validTo,
                FormStatus.Draft);
        ...
        {
            dao = DaoRegistry.GetDao<IFormGN7Dao>();
        ...
        private void RequeryAndAssertFieldsAreEqual(FormGN7 form)
        {
            var requeried = dao.QueryById(form.IdValue);
            ...
            Assert.AreEqual(form.DocumentLinks.First().TitleWithUrl, requeried.DocumentLinks.First().TitleWithUrl);
