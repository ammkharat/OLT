...
namespace Com.Suncor.Olt.Remote.DataAccess.Domain
{
    [TestFixture]
    [Category("Database")]
    public class FormGN6HistoryDaoTest : AbstractDaoTest
    {
        private IFormGN6HistoryDao dao;
        private IFormGN6Dao formDao;
        ...
        public void ShouldInsert()
        {
            ...
            var form = FormGN6Fixture.CreateForInsert(new List<FunctionalLocation> {floc2, floc1},
                validFromDateTime,
                validToDateTime,
                FormStatus.Draft);
        ...
        {
            dao = DaoRegistry.GetDao<IFormGN6HistoryDao>();
            formDao = DaoRegistry.GetDao<IFormGN6Dao>();
        }
