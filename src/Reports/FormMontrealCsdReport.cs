...
{
    public partial class FormMontrealCsdReport : XtraReport, IOltReport<FormMontrealCsdReportAdapter>
    {
        public FormMontrealCsdReport()
        {
            InitializeComponent();
        }

        public void SetMasterAndSubReportDataSource(List<FormMontrealCsdReportAdapter> adapters, DateTime currentTimeInSite)
        {
