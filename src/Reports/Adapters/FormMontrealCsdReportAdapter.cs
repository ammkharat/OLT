...
{
    public class FormMontrealCsdReportAdapter : FormReportAdapter
    {
        private readonly MontrealCsd form;

        public FormMontrealCsdReportAdapter(MontrealCsd form) : base(form)
        {
            this.form = form;
        }
        ...
        {
            get { return "Raison de la mise hors service:"; }
        }
