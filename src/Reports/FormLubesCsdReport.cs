...
{
    public partial class FormLubesCsdReport : XtraReport, IOltReport<FormLubesCsdReportAdapter>
    {
        public FormLubesCsdReport()
        {
            InitializeComponent();
        }

        public void SetMasterAndSubReportDataSource(List<FormLubesCsdReportAdapter> adapters, DateTime currentTimeInSite)
        {
