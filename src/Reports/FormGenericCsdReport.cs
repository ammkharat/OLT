...
{
    public partial class FormGenericCsdReport : XtraReport, IOltReport<FormGenericCsdReportAdapter>
    {
        public FormGenericCsdReport()
        {
            InitializeComponent();
        }

        public void SetMasterAndSubReportDataSource(List<FormGenericCsdReportAdapter> adapters, DateTime currentTimeInSite)
        {
