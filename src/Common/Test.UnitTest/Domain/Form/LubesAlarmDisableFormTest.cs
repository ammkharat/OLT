...
{
    [TestFixture]
    public class LubesAlarmDisableFormTest
    {
        [SetUp]
        public void SetUp()
        {
        ...
        public void AllApprovalsAreInShouldIgnoreDisabledOnes()
        {
            ...
            var form = LubesAlarmDisableFormFixture.CreateFormWithExistingId();
        ...
        public void CloneShouldNotIncludeCertainFields()
        {
            ...
            var form = LubesAlarmDisableFormFixture.CreateForInsert(floc,
                validFromDateTime,
                validToDateTime,
                FormStatus.Approved);
            form.Id = 22;
            ...
            form.Alarm = "Test alarm";
            form.Criticality = "1 - High";
            form.SapNotification = "Test SAP notification";
            ...
            Assert.AreEqual("Test alarm", form.Alarm);
            Assert.AreEqual("1 - High", form.Criticality);
            Assert.AreEqual("Test SAP notification", form.SapNotification);
