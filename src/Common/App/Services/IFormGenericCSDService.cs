...
{
    [ServiceContract]
    public interface IFormGenericCSDService
    {
        //ayman generic forms
        [OperationContract]
        ...
        [OperationContract]
        List<NotifiedEvent> InsertGenericCsd(GenericCsd form);
        ...
        [OperationContract]
        List<GenericCsd> QueryAllGenericCsdsThatAreApprovedAndAreMoreThan3DaysOutOfService(DateTime currentTimeAtSite);

        [OperationContract]
        List<GenericCsd> QueryAllGenericCsdsThatAreApprovedAndAreMoreThan5DaysOutOfService(DateTime currentTimeAtSite);
