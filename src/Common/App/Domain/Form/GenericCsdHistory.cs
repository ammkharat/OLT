...
{
    public class GenericCsdHistory : BaseFormHistory
    {
        public GenericCsdHistory(long id, FormStatus formStatus, string functionalLocations, string plainTextContent,
