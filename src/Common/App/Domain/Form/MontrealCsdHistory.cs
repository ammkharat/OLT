...
{
    public class MontrealCsdHistory : BaseFormHistory
    {
        public MontrealCsdHistory(long id, FormStatus formStatus, string functionalLocations, string plainTextContent,
