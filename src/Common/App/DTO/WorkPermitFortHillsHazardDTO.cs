...
{
    [Serializable]
    public class WorkPermitFortHillsHazardDTO : DomainObject, IHasStatus<PermitRequestBasedWorkPermitStatus>,
        IHasDataSource
    {
        private readonly long dataSourceId;
        private readonly long workPermitStatusId;

        public WorkPermitFortHillsHazardDTO(long id, long dataSourceId, long workPermitStatusId,
