...
{
    [Serializable]
    public class FormSarniaDTO : DomainObject, IHasStatus<FormStatus>, IFormSarniaDTO
    {
        private readonly List<string> functionalLocations = new List<string>();

        public FormSarniaDTO(long id, List<string> functionalLocations, EdmontonFormType formType,
