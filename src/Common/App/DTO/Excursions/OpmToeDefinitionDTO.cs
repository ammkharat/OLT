...
{
    [Serializable]
    public class OpmToeDefinitionDTO : DomainObject
    {
        public OpmToeDefinitionDTO(long id, long toeVersion, string historianTag, DateTime toeVersionPublishDate,
            ...
            string consequencesDescription, string correctiveActionDescription, string referencesDocuments,
            string unitOfMeasure, string opmToeHistoryUrl)
            : base(id)
        {
